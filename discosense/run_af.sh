export CLASSIFICATION_MODEL='../../experiments/albert_large_first'
export AUTOREGRESSIVE_MODEL='prajjwal1/ctrl_discovery_7'
export VALIDATION_DATA='../data/gen_valid.json'
export OUTPUT_DIR='../../experiments/albert_large_first'
export FILE_OUTPUT_PATH='../data/gen_valid_std_af_1.json'
# `gen_valid_std_af_1` -> ctrl_discovery_7
...
CUDA_VISIBLE_DEVICES=0 python3 run_af.py --replace_one --run_inference_only \
        ...
        --per_device_eval_batch_size $((BS*8)) --num_train_epochs $EPOCHS --file_output_path $FILE_OUTPUT_PATH --context_col $CONTEXT_COL \
