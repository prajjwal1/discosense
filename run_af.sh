export CLASSIFICATION_MODEL='albert-large-v2'
...
export VALIDATION_DATA='data/gen_valid_1_2af.json'
export OUTPUT_DIR='../experiments/albert-large'
export BS=18
...
CUDA_VISIBLE_DEVICES=0 python3 run_af.py --no_af\
