...
def main():
    ...
    train_ds = load_dataset(data_args.dataset_name, data_args.dataset_config_name, split='train[7%:]')
    validation_ds = load_dataset(data_args.dataset_name, data_args.dataset_config_name, split='validation')
